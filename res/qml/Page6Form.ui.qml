...
Item {
    ...
    ColumnLayout {
        ...
        Label {
            width: 357
            Layout.alignment: Qt.AlignCenter
            text: qsTr("A apresentação de slides será exibida durante a instalação da distro.
              A pasta deve conter as imagens como arquivos PNG com um tamanho recomendado de 800x400px. ")
    ...
    FileDialog {
        ...
        title: qsTr("Selecione uma pasta de apresentação de slides")
